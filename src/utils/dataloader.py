...
def get_dataset_info(dataset):
    base_dir = '/mnt/data/traffic_data/traffic_dataset/'
    d = {
        ...
        'PEMS03': [base_dir+'pems03/pems03', base_dir+'pems03/pems03/pems03_rn_adj.npy', 358],
        'PEMS04': [base_dir+'pems04/pems04', base_dir+'pems04/pems04/pems04_rn_adj.npy', 307],
        'PEMS07': [base_dir+'pems07/pems07', base_dir+'pems07/pems07/pems07_rn_adj.npy', 883],
        'PEMS08': [base_dir+'pems08/pems08', base_dir+'pems08/pems08/pems08_rn_adj.npy', 170],
        'PEMSBAY': [base_dir+'pemsbay/pemsbay', base_dir+'pemsbay/pemsbay/pemsbay_rn_adj.npy', 325],
        'METRLA': [base_dir+'metrla/metrla', base_dir+'metrla/metrla/metrla_rn_adj.npy', 207],
